...
class TestHHAPI(unittest.TestCase):
    ...
    def test_get_employer_success(self, mock):
        ...
        mock.get(f'https://api.hh.ru/employers/{self.employer_id}',
    ...
    def test_get_vacancies_success(self, mock):
        ...
        mock.get('https://api.hh.ru/vacancies',
                 json=self.mock_vacancies_data)
    ...
    def test_get_all_vacancies(self, mock):
        ...
        mock.get('https://api.hh.ru/vacancies', [
            {'json': {
                'items': [{'id': 1, 'name': 'Vacancy 1', 'employer': {'id': self.employer_id}}],
                'pages': 2
            }},
            {'json': {
                'items': [{'id': 2, 'name': 'Vacancy 2', 'employer': {'id': self.employer_id}}],
                'pages': 2
            }}
        ])
